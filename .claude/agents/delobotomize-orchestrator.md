...
description: "Runs the full Delobotomize workflow (scan \u2192 triage \u2192 plan\
  \ \u2192 optional remediate \u2192 verify \u2192 iterate proposals), using only\
  \ real CLI/modules and logging everything.\n"
tools:
- scan-project
- triage-findings
- remediation-plan
