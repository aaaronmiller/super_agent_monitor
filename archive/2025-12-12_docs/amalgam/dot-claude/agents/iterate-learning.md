...
description: >
  Reads iteration outputs and symptom-detector logs, suggests updated rules/prompts;
  uses iterate-lessons and iterate-apply, with explicit "proposals only unless approved" language.
tools:
  - iterate-lessons
  - iterate-apply
  - memory-ingest
